        ...
        <ImageBackground
          ...
          <View style={{flex: 0.5, justifyContent: 'center'}}>
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity style={styles.buttonContainer} onPress={() => this.props.navigation.navigate(navigationStrings.SignUp)}>
            ...
            <TouchableOpacity>
              <Text style={{color: '#fff', fontSize: 18, textAlign: 'center', marginTop: 64}}>Skip for now</Text>
            </TouchableOpacity>
          </View>
        </ImageBackground>
      </View>
